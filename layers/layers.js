...
var lyr_Eib_Lugares_0 = new ol.layer.Vector({
    ...
    popuplayertitle: 'Vías/Lugares Coles',
    interactive: true,
    opacity: 0.50000,
    title: 'Núcleos<br />'
});
...
// =========================================================================
var group_Municipio_Coles = new ol.layer.Group({
    ...
    title: '<span class="titulo-municipio-cabecera">MUNICIPIO DE COLES</span>'
});

// Pasamos únicamente el grupo maestro a la lista oficial de capas
var layersList = [group_Municipio_Coles];
